function the_table(inputObject) {
	...
	d3.tsv("regional-assumptions.tsv", function(data) {
		...
		if (isNaN(inputObject.price)) {
			inputObject.price = data[regionIndex]['price'];
			missingVals.push('price');
		}
		if (isNaN(inputObject.discount)) {
			inputObject.discount = '3';
			missingVals.push('discount');
		}
		if (isNaN(inputObject.pc)) {
			inputObject.pc = 0;
			missingVals.push('pc');
		}
		if (isNaN(inputObject.cost0)) {
			inputObject.cost0 = data[regionIndex]['cost0'];
			missingVals.push('cost0');
		}
		if (isNaN(inputObject.cost1)) {
			inputObject.cost1 = data[regionIndex]['cost1'];
			missingVals.push('cost1');
		}
		if (isNaN(inputObject.cost2)) {
			inputObject.cost2 = data[regionIndex]['cost2'];
			missingVals.push('cost2');
		}
		if (isNaN(inputObject.cost3)) {
			inputObject.cost3 = data[regionIndex]['cost3'];
			missingVals.push('cost3');
		}
		if (isNaN(inputObject.yield0)) {
			inputObject.yield0 = data[regionIndex]['yield0'];
			missingVals.push('yield0');
		}
		if (isNaN(inputObject.yield1)) {
			inputObject.yield1 = data[regionIndex]['yield1'];
			missingVals.push('yield1');
		}
		if (isNaN(inputObject.yield2)) {
			inputObject.yield2 = data[regionIndex]['yield2'];
			missingVals.push('yield2');
		}
		if (isNaN(inputObject.yield3)) {
			inputObject.yield3 = data[regionIndex]['yield3'];
			missingVals.push('yield3');
		}
		if (isNaN(inputObject.yield4)) {
			inputObject.yield4 = data[regionIndex]['yield4'];
			missingVals.push('yield4');
		}
		if (isNaN(inputObject.yield5)) {
			inputObject.yield5 = data[regionIndex]['yield5'];
