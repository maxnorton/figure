function the_table(discount, cost0, cost1, cost2, cost3, pc, price, yield0, yield1, yield2, yield3, yield4, yield5) {
	d3.tsv("yield-rates.tsv", function(data) {
		...
		the_table_html += '</tbody></table>' + '<p class="print-link"><a href="javascript:window.print()"><i class="fa fa-print" aria-hidden="true"></i> Print these results.</a></p><p class="adjust-link"><a href="#regionSelect" onclick="$(\'body,html\').stop(true,true).animate({scrollTop: $(\'#regionSelect\').offset().top - $(\'header\').height()}, \'500\', \'swing\');">Adjust parameters</a></p>';
